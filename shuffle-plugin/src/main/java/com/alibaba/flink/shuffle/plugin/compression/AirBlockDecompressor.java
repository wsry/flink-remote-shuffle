...
import static com.alibaba.flink.shuffle.plugin.compression.CompressorUtils.readIntLE;
import static com.alibaba.flink.shuffle.plugin.compression.CompressorUtils.validateLength;

/** Remote shuffle decompressor that wraps {@link Decompressor}. */
